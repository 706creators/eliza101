...
description: 基于 `eliza` 构建你的第一个Telegram Bot.
icon: Bot
---
...
最新版本的 `eliza` 支持了 自定义 URL 和模型的功能
...
- 方案 1
  因为,`pnpm run start` 执行的是 build 后的代码，所以，可以先 build。
...
<Youtube src="https://www.youtube.com/embed/YRJFj6ku63E?si=nipEUzOvkbD4xCsB"></Youtube>
